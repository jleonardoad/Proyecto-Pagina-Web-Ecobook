...
<div class="wrapper" id="app">
 ...
 <img src="./img/pages.jpg" alt="" class="brand-image img-box elevation-3"
  style="opacity: .8">
 <span class="brand-text font-weight-light">Ecobook</span>
  </a>
 ...
 <p> Archivos <i class="right fas fa-angle-left"></i>
 </p>
  </a>
  <ul class="nav nav-treeview">
 <li class="nav-item">
 ...
 <footer class="main-footer sticky">
  <!-- Default to the left -->
  <strong>Copyright &copy; 2019 Ecobook.</strong> Todos los derechos reservados.
 </footer>
</div>
<!-- ./wrapper -->
